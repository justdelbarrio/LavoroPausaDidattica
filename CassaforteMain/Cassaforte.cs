...
namespace CassaforteMain
{
    public class Cassaforte
    {
        ...
        public Cassaforte(int numeroMatricola, string produttore, string modello, string codiceSblocco, bool stato, string codiceUtente)
        {
        ...
        public Cassaforte() : this(0, null, null, null, false, null )
        {
        }   
        ...
        public string Chiudi()
        {
            ...
            {
                Stato = false;
                return "Cassaforte chiusa con successo.";
            }
            else
            {
                return "Cassaforte già chiusa.";
            }
        }
